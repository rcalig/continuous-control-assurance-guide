...
# [Unverified] Update to match your Week 1 assertion IDs
RELATED_ASSERTIONS = ["RAP-03"]
...
def main() -> None:
    ...
    mapping = {
        "cloudtrail_trails.json": "cloudtrail_trails.normalized.json",
        "cloudtrail_status.json": "cloudtrail_status.normalized.json",
    }
